 ...
 */
define('BOOKREAD', "SELECT b.name, b.author, b.cateogary FROM books AS b JOIN user ON user.book_read = b.id WHERE user.id = $userId");
  ...
  <div class="wrapper">
    <div class="container mt-5">
      <table class="table caption-top  table-hover" id="myTable">
        <h1>Your recent reding books</h1>
        <a class="btn btn-primary my-2" href="./AllBooks.php">See All Books</a>
        <thead>
